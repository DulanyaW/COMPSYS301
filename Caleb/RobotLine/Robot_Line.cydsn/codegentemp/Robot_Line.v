...
// Comp_v2_0(Hysteresis=1, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONFIG_TITLE=Comp_3, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_3, CY_INSTANCE_SHORT_NAME=Comp_3, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Comp_3, )
module Comp_v2_0_0 (
    clock,
    CmpOut,
    Vminus,
...
// Comp_v2_0(Hysteresis=1, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONFIG_TITLE=Comp_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Comp_0, CY_INSTANCE_SHORT_NAME=Comp_0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Comp_0, )
module Comp_v2_0_2 (
    clock,
    CmpOut,
    Vminus,
...
module top ;
	...
	wire [0:0] tmpOE__Sin_MidRight_net;
	wire [0:0] tmpFB_0__Sin_MidRight_net;
	wire [0:0] tmpIO_0__Sin_MidRight_net;
	wire [0:0] tmpINTERRUPT_0__Sin_MidRight_net;
	electrical [0:0] tmpSIOVREF__Sin_MidRight_net;

	cy_psoc3_pins_v1_10
		#(.id("42ef7877-873e-4467-a372-41e48f5038f4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Sin_MidRight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Sin_Right_net;
	wire [0:0] tmpFB_0__Sin_Right_net;
	wire [0:0] tmpIO_0__Sin_Right_net;
	wire [0:0] tmpINTERRUPT_0__Sin_Right_net;
	electrical [0:0] tmpSIOVREF__Sin_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("8f4dfff9-cbfa-48d8-b82d-f2ba8461274b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sin_Right
		 (.oe(tmpOE__Sin_Right_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sin_Right_net[0:0]}),
		  .analog({Net_189}),
		  .io({tmpIO_0__Sin_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__Sin_Right_net),
		  .interrupt({tmpINTERRUPT_0__Sin_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sin_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Sin_MidLeft_net;
	wire [0:0] tmpFB_0__Sin_MidLeft_net;
	wire [0:0] tmpIO_0__Sin_MidLeft_net;
	wire [0:0] tmpINTERRUPT_0__Sin_MidLeft_net;
	electrical [0:0] tmpSIOVREF__Sin_MidLeft_net;

	cy_psoc3_pins_v1_10
		#(.id("d6b8f119-ba31-41d0-ab46-9880fc091b31"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Sin_MidLeft_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Sin_Left_net;
	wire [0:0] tmpFB_0__Sin_Left_net;
	wire [0:0] tmpIO_0__Sin_Left_net;
	wire [0:0] tmpINTERRUPT_0__Sin_Left_net;
	electrical [0:0] tmpSIOVREF__Sin_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("3db36921-3c2b-4aff-a132-967578960f76"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sin_Left
		 (.oe(tmpOE__Sin_Left_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sin_Left_net[0:0]}),
		  .analog({Net_619}),
		  .io({tmpIO_0__Sin_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__Sin_Left_net),
		  .interrupt({tmpINTERRUPT_0__Sin_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sin_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("8ac5cf78-7615-4ee3-9cb2-40549828e972"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3fd0ec0f-5f38-48b9-bda5-b829082ea42f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bccfb2e5-74d7-4838-b0ba-2ef249deb525"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Sout_Left_net;
	wire [0:0] tmpFB_0__Sout_Left_net;
	wire [0:0] tmpIO_0__Sout_Left_net;
	wire [0:0] tmpINTERRUPT_0__Sout_Left_net;
	electrical [0:0] tmpSIOVREF__Sout_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("336b9abf-4a1b-41db-8b58-8e61fb698ed3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sout_Left
		 (.oe(tmpOE__Sout_Left_net),
		  .y({Net_10}),
		  .fb({tmpFB_0__Sout_Left_net[0:0]}),
		  .io({tmpIO_0__Sout_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__Sout_Left_net),
		  .interrupt({tmpINTERRUPT_0__Sout_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sout_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Sout_MidLeft_net;
	wire [0:0] tmpFB_0__Sout_MidLeft_net;
	wire [0:0] tmpIO_0__Sout_MidLeft_net;
	wire [0:0] tmpINTERRUPT_0__Sout_MidLeft_net;
	electrical [0:0] tmpSIOVREF__Sout_MidLeft_net;

	cy_psoc3_pins_v1_10
		#(.id("cdc83615-70b5-4ede-aec5-f28b52a6e484"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Sout_MidLeft
		 (.oe(tmpOE__Sout_MidLeft_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Sout_MidLeft_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sout_MidLeft_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Sout_MidRight_net;
	wire [0:0] tmpFB_0__Sout_MidRight_net;
	wire [0:0] tmpIO_0__Sout_MidRight_net;
	wire [0:0] tmpINTERRUPT_0__Sout_MidRight_net;
	electrical [0:0] tmpSIOVREF__Sout_MidRight_net;

	cy_psoc3_pins_v1_10
		#(.id("c1e39bcf-9de2-4875-9c43-33a571acc4c0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Sout_MidRight
		 (.oe(tmpOE__Sout_MidRight_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Sout_MidRight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sout_MidRight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Sout_Right_net;
	wire [0:0] tmpFB_0__Sout_Right_net;
	wire [0:0] tmpIO_0__Sout_Right_net;
	wire [0:0] tmpINTERRUPT_0__Sout_Right_net;
	electrical [0:0] tmpSIOVREF__Sout_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("c2cd3d53-41d0-4c62-91e4-4533ea8ebd8e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sout_Right
		 (.oe(tmpOE__Sout_Right_net),
		  .y({Net_135}),
		  .fb({tmpFB_0__Sout_Right_net[0:0]}),
		  .io({tmpIO_0__Sout_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__Sout_Right_net),
		  .interrupt({tmpINTERRUPT_0__Sout_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sout_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("fba3276f-a763-4aef-bd5b-64f2d2a486ee"),
		  .source_clock_id("315365C3-2E3E-4f04-84A2-BB564A173261"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
	...
	wire [0:0] tmpINTERRUPT_0__ENCD_Right_1_net;
	electrical [0:0] tmpSIOVREF__ENCD_Right_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ENCD_Right_1
		 (.oe(tmpOE__ENCD_Right_1_net),
		  .y({1'b0}),
		  .fb({Net_724}),
		  .io({tmpIO_0__ENCD_Right_1_net[0:0]}),
		  .siovref(tmpSIOVREF__ENCD_Right_1_net),
		  .interrupt({tmpINTERRUPT_0__ENCD_Right_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENCD_Right_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ENCD_Right_2_net;
	wire [0:0] tmpIO_0__ENCD_Right_2_net;
	wire [0:0] tmpINTERRUPT_0__ENCD_Right_2_net;
	electrical [0:0] tmpSIOVREF__ENCD_Right_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c733aa3b-68d4-4342-b0c2-587f63f26ac7"),
		  ...
		  .input_buffer_sel(2'b00))
		ENCD_Right_2
		 (.oe(tmpOE__ENCD_Right_2_net),
		  .y({1'b0}),
		  .fb({Net_725}),
		  .io({tmpIO_0__ENCD_Right_2_net[0:0]}),
		  .siovref(tmpSIOVREF__ENCD_Right_2_net),
		  .interrupt({tmpINTERRUPT_0__ENCD_Right_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENCD_Right_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpINTERRUPT_0__ENCD_Left_1_net;
	electrical [0:0] tmpSIOVREF__ENCD_Left_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3053e247-f233-446c-b52b-63c5431d0d39"),
		  ...
		  .input_buffer_sel(2'b00))
		ENCD_Left_1
		 (.oe(tmpOE__ENCD_Left_1_net),
		  .y({1'b0}),
		  .fb({Net_729}),
		  .io({tmpIO_0__ENCD_Left_1_net[0:0]}),
		  .siovref(tmpSIOVREF__ENCD_Left_1_net),
		  .interrupt({tmpINTERRUPT_0__ENCD_Left_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENCD_Left_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ENCD_Left_2_net;
	wire [0:0] tmpIO_0__ENCD_Left_2_net;
	wire [0:0] tmpINTERRUPT_0__ENCD_Left_2_net;
	electrical [0:0] tmpSIOVREF__ENCD_Left_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("79772720-a0e3-4c4c-9406-2e0ad94c56bf"),
		  ...
		  .input_buffer_sel(2'b00))
		ENCD_Left_2
		 (.oe(tmpOE__ENCD_Left_2_net),
		  .y({1'b0}),
		  .fb({Net_730}),
		  .io({tmpIO_0__ENCD_Left_2_net[0:0]}),
		  .siovref(tmpSIOVREF__ENCD_Left_2_net),
		  .interrupt({tmpINTERRUPT_0__ENCD_Left_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ENCD_Left_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_2860 = ~Net_2404;


    assign Net_2986 = ~Net_509;

	wire [0:0] tmpOE__IN2_Right_net;
	wire [0:0] tmpFB_0__IN2_Right_net;
	wire [0:0] tmpIO_0__IN2_Right_net;
	wire [0:0] tmpINTERRUPT_0__IN2_Right_net;
	electrical [0:0] tmpSIOVREF__IN2_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("9e2c6a73-37c8-4db6-9d98-7c283aacfddf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IN2_Right
		 (.oe(tmpOE__IN2_Right_net),
		  .y({Net_2404}),
		  .fb({tmpFB_0__IN2_Right_net[0:0]}),
		  .io({tmpIO_0__IN2_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__IN2_Right_net),
		  .interrupt({tmpINTERRUPT_0__IN2_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IN2_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IN1_Right_net;
	wire [0:0] tmpFB_0__IN1_Right_net;
	wire [0:0] tmpIO_0__IN1_Right_net;
	wire [0:0] tmpINTERRUPT_0__IN1_Right_net;
	electrical [0:0] tmpSIOVREF__IN1_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("8e539630-dc80-4fdb-acd0-f40833bf950a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IN1_Right
		 (.oe(tmpOE__IN1_Right_net),
		  .y({Net_2860}),
		  .fb({tmpFB_0__IN1_Right_net[0:0]}),
		  .io({tmpIO_0__IN1_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__IN1_Right_net),
		  .interrupt({tmpINTERRUPT_0__IN1_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IN1_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IN2_Left_net;
	wire [0:0] tmpFB_0__IN2_Left_net;
	wire [0:0] tmpIO_0__IN2_Left_net;
	wire [0:0] tmpINTERRUPT_0__IN2_Left_net;
	electrical [0:0] tmpSIOVREF__IN2_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("22ec0c4e-6355-4680-93e9-1c0f93238b18"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IN2_Left
		 (.oe(tmpOE__IN2_Left_net),
		  .y({Net_2986}),
		  .fb({tmpFB_0__IN2_Left_net[0:0]}),
		  .io({tmpIO_0__IN2_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__IN2_Left_net),
		  .interrupt({tmpINTERRUPT_0__IN2_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IN2_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IN1_Left_net;
	wire [0:0] tmpFB_0__IN1_Left_net;
	wire [0:0] tmpIO_0__IN1_Left_net;
	wire [0:0] tmpINTERRUPT_0__IN1_Left_net;
	electrical [0:0] tmpSIOVREF__IN1_Left_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("49aed1db-ee12-44e8-b805-47ec8fbe6a9d"),
		  ...
		  .input_buffer_sel(2'b00))
		IN1_Left
		 (.oe(tmpOE__IN1_Left_net),
		  .y({Net_509}),
		  .fb({tmpFB_0__IN1_Left_net[0:0]}),
		  .io({tmpIO_0__IN1_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__IN1_Left_net),
		  .interrupt({tmpINTERRUPT_0__IN1_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IN1_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__D1_Right_net;
	wire [0:0] tmpFB_0__D1_Right_net;
	wire [0:0] tmpIO_0__D1_Right_net;
	wire [0:0] tmpINTERRUPT_0__D1_Right_net;
	electrical [0:0] tmpSIOVREF__D1_Right_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e36a82f6-5137-46a7-9959-f7627e972919"),
		  ...
		  .input_buffer_sel(2'b00))
		D1_Right
		 (.oe(tmpOE__D1_Right_net),
		  .y({Net_1832}),
		  .fb({tmpFB_0__D1_Right_net[0:0]}),
		  .io({tmpIO_0__D1_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__D1_Right_net),
		  .interrupt({tmpINTERRUPT_0__D1_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D1_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__D1_Left_net;
	wire [0:0] tmpFB_0__D1_Left_net;
	wire [0:0] tmpIO_0__D1_Left_net;
	wire [0:0] tmpINTERRUPT_0__D1_Left_net;
	electrical [0:0] tmpSIOVREF__D1_Left_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("75fb4e60-5adc-4b69-9072-893c9be41f43"),
		  ...
		  .input_buffer_sel(2'b00))
		D1_Left
		 (.oe(tmpOE__D1_Left_net),
		  .y({Net_3236}),
		  .fb({tmpFB_0__D1_Left_net[0:0]}),
		  .io({tmpIO_0__D1_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__D1_Left_net),
		  .interrupt({tmpINTERRUPT_0__D1_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D1_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 CONTROL_DISABLE_1 (
        .clock(1'b0),
        .control_0(Net_1832),
        .control_1(Net_3236),
        .control_2(Net_862),
    ...
    defparam CONTROL_DISABLE_1.Bit2Mode = 0;
    defparam CONTROL_DISABLE_1.Bit3Mode = 0;
    defparam CONTROL_DISABLE_1.Bit4Mode = 0;
    defparam CONTROL_DISABLE_1.Bit5Mode = 0;
    defparam CONTROL_DISABLE_1.Bit6Mode = 0;
    defparam CONTROL_DISABLE_1.Bit7Mode = 0;
    defparam CONTROL_DISABLE_1.BitValue = 0;
    defparam CONTROL_DISABLE_1.BusDisplay = 0;
    defparam CONTROL_DISABLE_1.ExtrReset = 0;
    defparam CONTROL_DISABLE_1.NumOutputs = 2;

	wire [0:0] tmpOE__D2_Right_net;
	wire [0:0] tmpFB_0__D2_Right_net;
	wire [0:0] tmpIO_0__D2_Right_net;
	wire [0:0] tmpINTERRUPT_0__D2_Right_net;
	electrical [0:0] tmpSIOVREF__D2_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("00486199-8b45-49e2-b54d-6d9b24b051f1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		D2_Right
		 (.oe(tmpOE__D2_Right_net),
		  .y({Net_1610}),
		  .fb({tmpFB_0__D2_Right_net[0:0]}),
		  .io({tmpIO_0__D2_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__D2_Right_net),
		  .interrupt({tmpINTERRUPT_0__D2_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D2_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__D2_Left_net;
	wire [0:0] tmpFB_0__D2_Left_net;
	wire [0:0] tmpIO_0__D2_Left_net;
	wire [0:0] tmpINTERRUPT_0__D2_Left_net;
	electrical [0:0] tmpSIOVREF__D2_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("7ce01018-84e7-46c5-940e-44cc1d3500ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		D2_Left
		 (.oe(tmpOE__D2_Left_net),
		  .y({Net_1611}),
		  .fb({tmpFB_0__D2_Left_net[0:0]}),
		  .io({tmpIO_0__D2_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__D2_Left_net),
		  .interrupt({tmpINTERRUPT_0__D2_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D2_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 CONTROL_DISABLE_2 (
        .clock(1'b0),
        .control_0(Net_1610),
        .control_1(Net_1611),
        .control_2(Net_870),
        ...
        .control_7(Net_875),
        .reset(1'b0));
    defparam CONTROL_DISABLE_2.Bit0Mode = 0;
    defparam CONTROL_DISABLE_2.Bit1Mode = 0;
    defparam CONTROL_DISABLE_2.Bit2Mode = 0;
    defparam CONTROL_DISABLE_2.Bit3Mode = 0;
    defparam CONTROL_DISABLE_2.Bit4Mode = 0;
    defparam CONTROL_DISABLE_2.Bit5Mode = 0;
    defparam CONTROL_DISABLE_2.Bit6Mode = 0;
    defparam CONTROL_DISABLE_2.Bit7Mode = 0;
    defparam CONTROL_DISABLE_2.BitValue = 3;
    defparam CONTROL_DISABLE_2.BusDisplay = 0;
    defparam CONTROL_DISABLE_2.ExtrReset = 0;
    defparam CONTROL_DISABLE_2.NumOutputs = 2;

	wire [0:0] tmpOE__EN_Right_net;
	wire [0:0] tmpFB_0__EN_Right_net;
	wire [0:0] tmpIO_0__EN_Right_net;
	wire [0:0] tmpINTERRUPT_0__EN_Right_net;
	electrical [0:0] tmpSIOVREF__EN_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("6c32a951-2dd6-4dd9-86b4-5484d2f632eb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		EN_Right
		 (.oe(tmpOE__EN_Right_net),
		  .y({Net_1644}),
		  .fb({tmpFB_0__EN_Right_net[0:0]}),
		  .io({tmpIO_0__EN_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__EN_Right_net),
		  .interrupt({tmpINTERRUPT_0__EN_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EN_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EN_Left_net;
	wire [0:0] tmpFB_0__EN_Left_net;
	wire [0:0] tmpIO_0__EN_Left_net;
	wire [0:0] tmpINTERRUPT_0__EN_Left_net;
	electrical [0:0] tmpSIOVREF__EN_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("45c381f5-97af-4752-9004-78525b37f585"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		EN_Left
		 (.oe(tmpOE__EN_Left_net),
		  .y({Net_1645}),
		  .fb({tmpFB_0__EN_Left_net[0:0]}),
		  .io({tmpIO_0__EN_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__EN_Left_net),
		  .interrupt({tmpINTERRUPT_0__EN_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EN_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 CONTROL_ENABLE_0 (
        .clock(1'b0),
        .control_0(Net_1644),
        .control_1(Net_1645),
        .control_2(Net_878),
        ...
        .control_7(Net_883),
        .reset(1'b0));
    defparam CONTROL_ENABLE_0.Bit0Mode = 0;
    defparam CONTROL_ENABLE_0.Bit1Mode = 0;
    defparam CONTROL_ENABLE_0.Bit2Mode = 0;
    defparam CONTROL_ENABLE_0.Bit3Mode = 0;
    defparam CONTROL_ENABLE_0.Bit4Mode = 0;
    defparam CONTROL_ENABLE_0.Bit5Mode = 0;
    defparam CONTROL_ENABLE_0.Bit6Mode = 0;
    defparam CONTROL_ENABLE_0.Bit7Mode = 0;
    defparam CONTROL_ENABLE_0.BitValue = 3;
